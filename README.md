# Visão Geral
Este é um projeto de demonstração de desenvolvimento de MVC com Laravel com retorno de clientes baseado em banco de dados.
...
**Data da última atualização**: 2023-05-29  
**Versão**: 1.0.10
...
## Funcionalidades
1. Fornece uma página com lista de clientes.
...
4. MySQL
5. Banco de dados previamente preenchido
